...
// Sprawdzamy, czy parametr idp jest przekazany w URL
if (isset($_GET['idp'])) {
    $id = $_GET['idp'];
...
} elseif ($_GET['idp'] == 'admin') {  // Nowy warunek dla admin.php
    header("Location: admin/admin.php"); // Przekierowanie do admin.php
    exit();
} else {
    $strona = __DIR__ . '/html/strona_głowna.html';
}
        ...
        <nav>
            <ul class="menu">
                ...
                <li><a href="strona_głowna.php?idp=kontakt">Kontakt</a></li>
				 <li><a href="strona_głowna.php?idp=admin">Panel Administratora</a></li> 
            </ul>
            </ul>
        </nav>
    </header>
